...
<main id="admin-main" class="grid grid-cols-2">
    <!-- 1st column (page) to manage access and database -->


    <!-- 2nd column (page) to make changes -->
    <div id="editing-part">
        <?php include 'partials/edit-page.php'; ?>
    </div>

    <!-- 3rd column (page) to preview changes -->
    <div id="preview-part">
